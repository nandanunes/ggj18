...
public class ClickableText : MonoBehaviour, IPointerDownHandler
{
    ...
    void Start()
    {
        ...
        list.Add(new ActionBlock(-10, "Why gotta be green?", new Replacement[] { new Replacement("violet", "violet", 0, ""), new Replacement("pink", "pink", -10, "PINK on TV? #boycottAlienCable"), new Replacement("cyan", "cyan", -10, "A cyan costume? Oh my tentacles!! Disgusting"), new Replacement("purple", "purple", -10, "Purplease spare me from having to look at these weird colors") }));
        ...
        list.Add(new ActionBlock(-15, "Look at the way they open their mouths and make those horrible noises #stopLaughter #AlienRightsNow", new Replacement[] { new Replacement("screams", "screams", 0, ""), new Replacement("cries", "cries", 0, ""), new Replacement("nods", "nods in approval", 10, "This is how civilized beings should behive. I aprove this"), new Replacement("chuckles", "chuckles", -10, "LAUGHING IS NOT ENOUGH? CHUCKLING????") }));
        list.Add(new ActionBlock(0, "", new Replacement[] { new Replacement("violet", "violet", 0, ""), new Replacement("pink", "pink", -10, "PINK on TV? #boycottAlienCable"), new Replacement("cyan", "cyan", -10, "Ugh. This color hurts my eyes"), new Replacement("purple", "purple", -10, "Purplease spare me from having to look at these weird colors") }));
        list.Add(new ActionBlock(-10, "That's offensive! We are #OneNation! [b]NO FLAGS[/b]", new Replacement[] { new Replacement("hamburger", "hambuger?", 0, ""), new Replacement("regular meaningless cloth", "regular meaningless cloth", 0, ""), new Replacement("vinyl jacket", "vinyl jacket", -10, "I vomited on my television. Hope AlienCable refunds me AFTER I SUE THEM. #stop #vinyl") }));
    ...
    void loadLevel(int n)
    {
        ...
        if (n == 1)
        {
            ...
            //list.Add(new ActionBlock(-10, "What is this? Brainwashing? #stopBranding", new Replacement[] { new Replacement("all pet stores", "all pet stores combined", 5, "Beautiful! All pet stores are one! #emotional"), new Replacement("the whole population", "the whole alien population", 0, "WHAT? Oh, well ok."), new Replacement("AlienCable", "AlienCable", 10, "AlienCable is the best!!!") }));
            //list.Add(new ActionBlock(-10, "Filthy Human companies being broadcast in my home? I don't think so... #destroyAlienCable", new Replacement[] { new Replacement("Generic", "generic", 5, ""), new Replacement("just biscuits", "just biscuit", 5, ""), new Replacement("delicious", "delicious", 5, "") }));
            ...
            //list.Add(new ActionBlock(-10, "Is it a dog or a slave? #freeTheDogs", new Replacement[] { new Replacement("any pet store", "some pet store", 15, ""), new Replacement("Alien Brand (tm)", "AlienBrand(tm)", -10, "A TV show that talks about brands??? IS THIS CAPITALISM??"), new Replacement("", "", , "") }));
            ...
            //list.Add(new ActionBlock(-10, "Stop branding! I can't take it anymore", new Replacement[] { new Replacement("a delicious biscuit", "a delicious biscuit", 10, ""), new Replacement("", "", , ""), new Replacement("", "", , "") }));
            //list.Add(new ActionBlock(-10, "Is it a dog or a slave? #freeTheDogs", new Replacement[] { new Replacement("Bebecita", "Bebecita", -10, "Is it a dog or a slave? #freeTheDogs"), new Replacement("Baby girl", "Baby girl", -10, "Is it a dog or a slave? #freeTheDogs"), new Replacement("Madison", "Madison", 10, "Oh what a cute dog-owner pair <3") }));
            //list.Add(new ActionBlock(-10, "Is it a dog or a slave? #freeTheDogs", new Replacement[] { new Replacement("Bebecita", "Bebecita", -10, "Is it a dog or a slave? #freeTheDogs"), new Replacement("Baby girl", "Baby girl", -10, "Is it a dog or a slave? #freeTheDogs"), new Replacement("Madison", "Madison", 10, "Oh what a cute dog-owner pair <3") }));
